...
public class CombatTests extends GroovyTestCase {
    ...
    public void testBasicMinionsAttack() {
        ...
        assertTrue("Verify Yeti_1 is in play zone", new Link(yeti1, game) in game.play);
        assertTrue("Verify Yeti_2 is in graveyard zone", new Link(yeti2, game) in game.graveyard);
    }
